...
extension Container {
    ...
    ///   - argument:   1 argument to pass to the factory closure.
    ///
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and 1 argument is found in the `Container`.
    public func unsafeResolve<Service, Arg1>(
      _ serviceType: Service.Type,
      argument: Arg1) -> Service
    {
      return unsafeResolve(serviceType, name: nil, argument: argument)
    }
    ...
    {
        typealias FactoryType = ((Resolver, Arg1)) -> Any
        return _unsafeResolve(name: name) { (factory: FactoryType) in factory((self, argument)) }
    }
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 2 arguments is found in the `Container`.
    public func unsafeResolve<Service, Arg1, Arg2>(
      _ serviceType: Service.Type,
      arguments arg1: Arg1, _ arg2: Arg2) -> Service
    {
      return unsafeResolve(serviceType, name: nil, arguments: arg1, arg2)
    }
    ...
    {
        typealias FactoryType = ((Resolver, Arg1, Arg2)) -> Any
        return _unsafeResolve(name: name) { (factory: FactoryType) in factory((self, arg1, arg2)) }
    }
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 3 arguments is found in the `Container`.
    public func unsafeResolve<Service, Arg1, Arg2, Arg3>(
      _ serviceType: Service.Type,
      arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3) -> Service
    {
      return unsafeResolve(serviceType, name: nil, arguments: arg1, arg2, arg3)
    }
    ...
    {
        typealias FactoryType = ((Resolver, Arg1, Arg2, Arg3)) -> Any
        return _unsafeResolve(name: name) { (factory: FactoryType) in factory((self, arg1, arg2, arg3)) }
    }
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 4 arguments is found in the `Container`.
    public func unsafeResolve<Service, Arg1, Arg2, Arg3, Arg4>(
      _ serviceType: Service.Type,
      arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4) -> Service
    {
      return unsafeResolve(serviceType, name: nil, arguments: arg1, arg2, arg3, arg4)
    }
    ...
    {
        typealias FactoryType = ((Resolver, Arg1, Arg2, Arg3, Arg4)) -> Any
        return _unsafeResolve(name: name) { (factory: FactoryType) in factory((self, arg1, arg2, arg3, arg4)) }
    }
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 5 arguments is found in the `Container`.
    public func unsafeResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5>(
      _ serviceType: Service.Type,
      arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5) -> Service
    {
      return unsafeResolve(serviceType, name: nil, arguments: arg1, arg2, arg3, arg4, arg5)
    }
    ...
    {
        typealias FactoryType = ((Resolver, Arg1, Arg2, Arg3, Arg4, Arg5)) -> Any
        return _unsafeResolve(name: name) { (factory: FactoryType) in factory((self, arg1, arg2, arg3, arg4, arg5)) }
    }
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 6 arguments is found in the `Container`.
    public func unsafeResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6>(
      _ serviceType: Service.Type,
      arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6) -> Service
    {
      return unsafeResolve(serviceType, name: nil, arguments: arg1, arg2, arg3, arg4, arg5, arg6)
    }
    ...
    {
        typealias FactoryType = ((Resolver, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6)) -> Any
        return _unsafeResolve(name: name) { (factory: FactoryType) in factory((self, arg1, arg2, arg3, arg4, arg5, arg6)) }
    }
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 7 arguments is found in the `Container`.
    public func unsafeResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7>(
      _ serviceType: Service.Type,
      arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6, _ arg7: Arg7) -> Service
    {
      return unsafeResolve(serviceType, name: nil, arguments: arg1, arg2, arg3, arg4, arg5, arg6, arg7)
    }
    ...
    {
        typealias FactoryType = ((Resolver, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7)) -> Any
        return _unsafeResolve(name: name) { (factory: FactoryType) in factory((self, arg1, arg2, arg3, arg4, arg5, arg6, arg7)) }
    }
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 8 arguments is found in the `Container`.
    public func unsafeResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8>(
      _ serviceType: Service.Type,
      arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6, _ arg7: Arg7, _ arg8: Arg8) -> Service
    {
      return unsafeResolve(serviceType, name: nil, arguments: arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)
    }
    ...
    {
        typealias FactoryType = ((Resolver, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8)) -> Any
        return _unsafeResolve(name: name) { (factory: FactoryType) in factory((self, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)) }
    }
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 9 arguments is found in the `Container`.
    public func unsafeResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9>(
      _ serviceType: Service.Type,
    ...
    {
      return unsafeResolve(serviceType, name: nil, arguments: arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9)
    }
    ...
    {
        typealias FactoryType = ((Resolver, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9)) -> Any
        return _unsafeResolve(name: name) { (factory: FactoryType) in factory((self, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9)) }
    }
}
