...
public protocol Resolver {
    ...
    /// Retrieves the instance with the specified service type in unsafe way.
    ///
    /// - Parameter serviceType: The service type to resolve.
    ///
    ...
    ///
    /// - Returns: The resolved service type instance, or cause fatalError() if no service is found.
    func unsafeResolve<Service>(_ serviceType: Service.Type, name: String?) -> Service
    ...
    ///            and 1 argument is found.
    func unsafeResolve<Service, Arg1>(
        _ serviceType: Service.Type,
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 2 arguments is found.
    func unsafeResolve<Service, Arg1, Arg2>(
        _ serviceType: Service.Type,
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 3 arguments is found.
    func unsafeResolve<Service, Arg1, Arg2, Arg3>(
        _ serviceType: Service.Type,
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 4 arguments is found.
    func unsafeResolve<Service, Arg1, Arg2, Arg3, Arg4>(
        _ serviceType: Service.Type,
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 5 arguments is found.
    func unsafeResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5>(
        _ serviceType: Service.Type,
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 6 arguments is found.
    func unsafeResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6>(
        _ serviceType: Service.Type,
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 7 arguments is found.
    func unsafeResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7>(
        _ serviceType: Service.Type,
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 8 arguments is found.
    func unsafeResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8>(
        _ serviceType: Service.Type,
    ...
    /// - Returns: The resolved service type instance, or cause fatalError() if no registration for the service type
    ///            and list of 9 arguments is found.
    func unsafeResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9>(
        _ serviceType: Service.Type,
